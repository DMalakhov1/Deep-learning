...
- Добавить единый `requirements.txt` в корень репозитория.
- Добавить отдельные `requirements.txt` для `competition_cv` и `competition_nlp`.
- Переименовать ноутбуки в более читаемый формат без пробелов и служебных символов.
- Добавить краткие EDA-скриншоты и графики в README каждой папки.
- Добавить таблицу с финальными public/private score для всех соревнований.
- Вынести ключевые пайплайны из ноутбуков в `.py`-скрипты для воспроизводимости.
- Удалить разговорные комментарии из публичной версии ноутбуков или перенести их в личные заметки.
